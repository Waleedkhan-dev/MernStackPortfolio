...
export const projects: Project[] = [
  ...
  },
  {
    slug: 'botbytesai',
    title: 'BotBytesAI',
    tagline: 'AI chatbot SaaS for businesses.',
    category: 'AI / SaaS',
    year: '2025',
    image: '/projects/botbytesai.png',
    featured: true,
    tech: ['Next.js', 'TypeScript', 'OpenAI', 'LangChain', 'Node.js', 'PostgreSQL', 'Tailwind CSS'],
    description:
      'An AI SaaS platform that lets businesses create and embed custom chatbots trained on their own data, with conversation analytics and a subscription model.',
    features: [
      'Custom AI chatbots powered by OpenAI + LangChain',
      'Train bots on business-specific knowledge bases',
      'Embeddable widget for any website',
      'Conversation history and analytics dashboard',
      'Subscription billing and multi-tenant accounts',
    ],
    architecture:
      'Next.js app with a Node backend orchestrating LLM calls through LangChain. Vector embeddings for retrieval-augmented answers, PostgreSQL for tenants/usage, and an embeddable JS widget. Streaming responses for low perceived latency.',
    challenges: [
      'Keeping LLM responses grounded in each tenant’s data (RAG) to reduce hallucination',
      'Streaming tokens efficiently while tracking usage for billing',
    ],
    lessons: [
      'Retrieval quality matters more than prompt cleverness for grounded answers',
      'Designing for multi-tenancy from day one avoids painful refactors later',
    ],

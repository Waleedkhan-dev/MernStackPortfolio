...
const AboutMe = () => {
 useEffect(() => {
  AOS.init({
   ...
   easing: 'ease-out-back', // More dramatic easing
   delay: 100,
  ...
  <Fragment>
   <div id="about" className="flex flex-col md:flex-row justify-evenly items-center p-4">
    ...
    <div data-aos="fade-left"
     ...
     <div className="mt-5">
      <button onClick={handleDownload} className="border-4 cursor-pointer rounded-3xl border-[#FF014F] text-[#FF014F] px-5 py-2 hover:bg-[#FF014F] hover:text-white transition-colors duration-300">
       Download CV
      </button>
     </div>
    </div>

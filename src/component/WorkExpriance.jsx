    ...
    <div className="flex justify-center text-start gap-2 p-2 md:p-2 lg:p-4 items-start">
     ...
     <div className="text-wrap">
      ...
      <div className="mb-2 lg:mb-6 md:mb-4">
       <h1 className="text-xl font-medium text-white">Software Engineer</h1>
       <h2 className="text-lg text-gray-300">Sep 2025 - Present</h2>
       <p className="text-gray-300">Algotix AI (Onsite)</p>
      </div>

      <div className="mb-2 lg:mb-6 md:mb-4">
       <h1 className="text-xl font-medium text-white">MERN Stack Developer</h1>
       <h2 className="text-lg text-gray-300">Jul 2025 - Sep 2025</h2>
       <p className="text-gray-300">Hubble42 Inc. (Onsite)</p>
      </div>

      <div className="mb-2 lg:mb-6 md:mb-4">
       <h1 className="text-xl font-medium text-white">MERN Stack Developer</h1>
       <h2 className="text-lg text-gray-300">Jan 2025 - Jul 2025</h2>
       <p className="text-gray-300">Codings First (Onsite)</p>
      </div>

      <div className="mb-2 lg:mb-6 md:mb-4">
       <h1 className="text-xl font-medium text-white">Frontend Internship</h1>
       <h2 className="text-lg text-gray-300">Aug 2024 - Dec 2024</h2>
       <p className="text-gray-300">Codesthinker (Onsite)</p>
      </div>
     </div>
    </div>
   </div>
